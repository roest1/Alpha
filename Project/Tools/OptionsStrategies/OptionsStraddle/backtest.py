...
After we've gathered all available call and put options
we'll extract only the strike price existing in both options
"""
...
Merging option price info with spot price
"""
...
Find option pair at the closest price possible
"""
...
#for stoxx 50 options, the contract size is 10 ticks per euro #(dollar?)
...
#when the price difference of call and put is smaller than 2 euros # -> dollar
