...
Can scrape the following website of cme instead
...
"""
get_options_call_inclusion()

select out of money call options with zero prior settle exclusion
"""
...
Select out of money put options with zero prior settle exclusion
"""
...
based on variance swap formula
"""
...
def main():
    ...
    #read data
    df=pd.read_csv('henry_hub_european_options.csv')
    calendar=pd.read_csv('cme_holidays.csv')
    cmt_rate=pd.read_csv('treasury_yield_curve_rates.csv')
